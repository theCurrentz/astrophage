 ...
 * **Velocity integration:** forces accumulate into `velocity`, then `position += velocity * dt`.
 */
 ...
 * Intuition: the field “swirls” like fluid because divergence is near zero.
 */
...
/**
 * One simulation tick: curl drift, cohesion toward centroid, damping, soft box clamp.
 */
